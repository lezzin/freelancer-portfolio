...
const projects: Project[] = [
  ...
  // -------------------------- CHATBOT -------------------------------------
  {
    ...
    description:
      "Chatbot de geração automática de flashcards, com planos de assinatura.",
    detailedDescription: `
  ...
  // -------------------------- FERRAMENTAS DEV -----------------------------
  {
    ...
    imageDetails: [
      ...
      { src: "ferramentas-dev-2.png", label: "Página inicial (dark)" },
      {
        ...
        label: "Categoria selecionada (light - usuário)",
      },
      {
        src: "ferramentas-dev-4.png",
        label: "Categoria selecionada (dark - usuário)",
      },
      {
        src: "ferramentas-dev-5.png",
        label: "Categoria selecionada (light - admin)",
      },
    ],
